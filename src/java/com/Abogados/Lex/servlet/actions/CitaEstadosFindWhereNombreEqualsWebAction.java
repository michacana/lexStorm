...
public class CitaEstadosFindWhereNombreEqualsWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			CitaEstados dto[] = dao.findWhereNombreEquals(nombre);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/CitaEstadosFindWhereNombreEqualsResult.jsp" );
		}
		catch (Exception e) {
