...
public class DocumentosCitasFindByCitasWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			DocumentosCitas dto[] = dao.findByCitas(idCita);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/DocumentosCitasFindByCitasResult.jsp" );
		}
		catch (Exception e) {
