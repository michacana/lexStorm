...
public class EmpresaClientesFindByEmpresasWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			EmpresaClientes dto[] = dao.findByEmpresas(idEmpresa);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/EmpresaClientesFindByEmpresasResult.jsp" );
		}
		catch (Exception e) {
