...
public class PagosFindWhereFechaHoraEqualsWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			Pagos dto[] = dao.findWhereFechaHoraEquals(fechaHora);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/PagosFindWhereFechaHoraEqualsResult.jsp" );
		}
		catch (Exception e) {
