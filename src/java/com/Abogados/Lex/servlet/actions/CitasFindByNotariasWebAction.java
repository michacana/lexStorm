...
public class CitasFindByNotariasWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			Citas dto[] = dao.findByNotarias(idNotaria);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/CitasFindByNotariasResult.jsp" );
		}
		catch (Exception e) {
