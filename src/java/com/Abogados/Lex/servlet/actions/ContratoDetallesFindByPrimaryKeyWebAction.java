...
public class ContratoDetallesFindByPrimaryKeyWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			ContratoDetalles dto = dao.findByPrimaryKey(idDetalleContrato);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/ContratoDetallesFindByPrimaryKeyResult.jsp" );
		}
		catch (Exception e) {
