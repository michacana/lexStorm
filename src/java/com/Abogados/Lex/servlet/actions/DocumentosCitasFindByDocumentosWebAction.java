...
public class DocumentosCitasFindByDocumentosWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			DocumentosCitas dto[] = dao.findByDocumentos(idDocumento);
		
			// store the results
			request.setAttribute( "result", dto );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/DocumentosCitasFindByDocumentosResult.jsp" );
		}
		catch (Exception e) {
